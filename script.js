...
const TRANSLATIONS = {
  ar: {
    ...
    quick_maintenance:'اطلب صيانة دلوقتي', quick_team:'تعرف على فريقنا', quick_parts:'قطع الغيار',
  ...
  en: {
    ...
    quick_maintenance:'Request Maintenance', quick_team:'Meet Our Team', quick_parts:'Spare Parts',
